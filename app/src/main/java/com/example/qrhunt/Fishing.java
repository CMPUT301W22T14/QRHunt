...
public class Fishing {
    public String choice = "LOCAL";

    public String uuidForLocal = null;
    public String uuidForInput = null;

    public FireDatabase fdbForLocal = null;
    public FireDatabase fdbForInput = null;

    public Player playerForLocal = null;
    public Player playerForInput = null;
