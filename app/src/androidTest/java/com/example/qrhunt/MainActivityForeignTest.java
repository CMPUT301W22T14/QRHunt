...
public class MainActivityForeignTest {
    private Solo solo;
    ...
    @Test
    public void checkForeignPlayer_ProfilePage() {
        solo.waitForDialogToOpen();
        solo.clickOnButton("Foreign Player");
        try {
            solo.wait(50000);
    ...
    @Test
    public void checkForeignPlayer_MoreButton() {
        solo.waitForDialogToOpen();
        solo.clickOnButton("Foreign Player");
        try {
            solo.wait(50000);
    ...
    @Test
    public void checkForeignPlayer_MoreButton_ScanCode() {
        solo.waitForDialogToOpen();
        solo.clickOnButton("Foreign Player");
        try {
            solo.wait(50000);
    ...
    @Test
    public void checkForeignPlayer_MoreButton_Map() {
        solo.waitForDialogToOpen();
        solo.clickOnButton("Foreign Player");
        try {
            solo.wait(50000);
    ...
    @Test
    public void checkForeignPlayer_MoreButton_LeaderBoard() {
        solo.waitForDialogToOpen();
        solo.clickOnButton("Foreign Player");
        try {
            solo.wait(50000);
    ...
    @Test
    public void checkForeignPlayer_MoreButton_SearchingByUserName() {
        solo.waitForDialogToOpen();
        solo.clickOnButton("Foreign Player");
        try {
            solo.wait(50000);
    ...
    @Test
    public void checkForeignPlayer_MoreButton_OthersCodes() {
        solo.waitForDialogToOpen();
        solo.clickOnButton("Foreign Player");
        try {
            solo.wait(50000);
    ...
    @Test
    public void checkForeignPlayer_MoreButton_SearchCodesByGeolocation() {
        solo.waitForDialogToOpen();
        solo.clickOnButton("Foreign Player");
        try {
            solo.wait(50000);
